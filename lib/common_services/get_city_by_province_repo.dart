...
class GetCityByProvinceList {
  Future<dynamic> getCityByProvinceList(String provinceId) async {
    try {
      var path = "$baseUrl$getCityByProvinceListUrl?provinceId=$provinceId";
      log(path);
      ...
      if (resp.statusCode == 200 || resp.statusCode == 201) {
        ...
        List<CityByProvince> cityByProvinceList = [];
        decodedResponce.forEach((v) {
          cityByProvinceList.add(CityByProvince.fromJson(v));
        });
