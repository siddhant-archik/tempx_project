...
class SetPasswordRepo {
  Future<String> setCandidatePassword(
      SetPasswordModel candidatePasswordData) async {
    var finalCandidatePasswordData = {
      "email": candidatePasswordData.email,
      "password": candidatePasswordData.password
    };
    var path = baseUrl + candidateSetPasswordUrl;
    print(finalCandidatePasswordData);
    try {
      final resp = await http.post(
        ...
        body: finalCandidatePasswordData,
      );
