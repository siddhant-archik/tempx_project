...
import 'package:tempx_project/modules/employer_registration_module/screens/otp_verification_screen.dart';
import 'package:tempx_project/utils/konstants.dart';

class MobileNumberRegisterationScreen extends StatefulWidget {
  final String isLoginOrRegistration;
  const MobileNumberRegisterationScreen(
      {super.key, required this.isLoginOrRegistration});

  @override
  State<MobileNumberRegisterationScreen> createState() =>
      _MobileNumberRegisterationScreenState();
}

class _MobileNumberRegisterationScreenState
    extends State<MobileNumberRegisterationScreen> {
      ...
      child: BlocListener<SendOtpToMobileBloc, SendOtpToMobileState>(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              'Employer ${widget.isLoginOrRegistration}',
              style:
